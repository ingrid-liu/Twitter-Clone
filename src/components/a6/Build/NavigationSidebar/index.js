    ...
    return(
        <>
            <div className="list-group">
                ...
                <a className={`list-group-item ${active === 'notification' ? 'active' : ''}`} href="notifications.html">
                    <i className="fa fa-bell " style={floatLeft}></i>
                    <span className="wd-navigation-words d-inline d-none d-xl-block" style={floatLeft}>
                        Notification</span>
                </a>
                <a className={`list-group-item ${active === 'message' ? 'active' : ''}`} href="messages.html">
                ...
                <a className={`list-group-item ${active === 'more' ? 'active' : ''}`} href=".more.html.html">
