const NavigationSidebar = (active) => {
    return(`
            ...
            <!-- continue the rest of the list -->
                ...
                <a class="list-group-item ${active === 'notification' ? 'active' : ''}" href="notifications.html">
                    <i class="fa fa-bell " style="float: left"></i>
                    <span class="wd-navigation-words d-inline d-none d-xl-block" style="float: left">
                        Notification</span>
                </a>
                <a class="list-group-item ${active === 'message' ? 'active' : ''}" href="messages.html">
                ...
                <a class="list-group-item ${active === 'more' ? 'active' : ''}" href=".more.html.html">
